    ...
    <div className="px-4 py-6 sm:px-0">
      <div className="mb-6 flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600 mt-1">Manage your label setup projects</p>
        </div>
        <Link
          href="/projects/new"
        ...
        <div className="bg-white overflow-hidden shadow rounded-lg">
          <div className="p-6">
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  <dt className="text-sm font-medium text-gray-500 truncate">Total Setups</dt>
                  <dd className="text-lg font-medium text-gray-900">
                    {projects.reduce((total, project) => total + (project.labelSetupCount || 0), 0)}
                  </dd>
                </dl>
              </div>
            </div>
          ...
          {loading ? (
            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
              {projects.map((project) => (
                <div key={project.id} className="bg-gray-50 overflow-hidden shadow rounded-lg hover:shadow-md transition-shadow">
                  <div className="p-6">
